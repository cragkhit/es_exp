public class PointInTriangle extends java.awt.Frame {
    public java.awt.Polygon f03;
    public java.awt.Point f13;
    public PointInTriangle() {
        super();
        this.f03 = new java.awt.Polygon();
        this.f13 = new java.awt.Point();
    }
    public static void m03 ( java.awt.Graphics a, int i, int i0, int i1, java.awt.Paint a0 ) {
    ...
    public void paint ( java.awt.Graphics a ) {
        ...
        a0.draw ( ( java.awt.Shape ) ( Object ) this.f03 );
        a0.setPaint ( ( java.awt.Paint ) ( Object ) java.awt.Color.green );
        PointInTriangle.m03 ( a1, this.f13.x, this.f13.y, 3, ( java.awt.Paint ) ( Object ) java.awt.Color.blue );
    }
    public static int m23 ( float f, float f0, float f1, float f2, float f3, float f4 ) {
        float f5 = 0.0f;
        float f6 = 0.0f;
        if ( f < f1 ) {
            f5 = f;
    ...
    public static int m33 ( float f, float f0, float f1, float f2, float f3, float f4, float f5, float f6 ) {
        float f7 = ( f2 - f0 ) / ( f1 - f );
        float f8 = f0 - f7 * f;
        ...
        float f12 = f7 * f11 + f8;
        if ( PointInTriangle.m23 ( f, f0, f1, f2, f11, f12 ) == 1 && PointInTriangle.m23 ( f3, f4, f5, f6, f11, f12 ) == 1 ) {
            return 1;
        }
        return 0;
    }
    ...
    public static void main ( String[] a ) {
        ...
        while ( i < 3 ) {
            ...
            ( ( java.util.List ) ( Object ) a0 ).add ( ( Object ) Integer.valueOf ( PointInTriangle.m43() ) );
        ...
        while ( i0 < ( ( java.util.List ) ( Object ) a0 ).size() ) {
            int i1 = ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( i0 ) ).intValue();
            int i2 = i0 + 1;
            int i3 = ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( i2 ) ).intValue();
            a5.f03.addPoint ( i1, i3 );
            i0 = i2 + 1;
        }
        System.out.format ( "Enter Point X: ", new Object[0] );
        int i4 = PointInTriangle.m43();
        System.out.format ( "Enter Point Y: ", new Object[0] );
        int i5 = PointInTriangle.m43();
        int i6 = i4 + 1000;
        a5.f13.x = i4;
        a5.f13.y = i5;
        if ( ( 0 + PointInTriangle.m33 ( ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 0 ) ).intValue(), ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 1 ) ).intValue(), ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 2 ) ).intValue(), ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 3 ) ).intValue(), ( float ) i4, ( float ) i5, ( float ) i6, ( float ) i5 ) + PointInTriangle.m33 ( ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 2 ) ).intValue(), ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 3 ) ).intValue(), ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 4 ) ).intValue(), ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 5 ) ).intValue(), ( float ) i4, ( float ) i5, ( float ) i6, ( float ) i5 ) + PointInTriangle.m33 ( ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 4 ) ).intValue(), ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 5 ) ).intValue(), ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 0 ) ).intValue(), ( float ) ( ( Integer ) ( ( java.util.List ) ( Object ) a0 ).get ( 1 ) ).intValue(), ( float ) i4, ( float ) i5, ( float ) i6, ( float ) i5 ) ) % 2 != 1 ) {
