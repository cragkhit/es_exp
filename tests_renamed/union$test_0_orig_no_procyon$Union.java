class Union {
    ...
    static int[] Union_Array ( final int[] array, final int[] array2 ) {
        final int[] find_Common_Elements = Find_Common_Elements ( array, array2 );
        final int[] array3 = new int[array.length + array2.length - find_Common_Elements.length];
        int n = 0;
        for ( int i = 0; i < array.length; ++i ) {
            array3[n++] = array[i];
        }
        for ( int j = 0; j < array2.length; ++j ) {
            ...
            for ( int k = 0; k < find_Common_Elements.length; ++k ) {
                if ( find_Common_Elements[k] == array2[j] ) {
                    n2 = 0;
                    break;
                }
            }
    ...
    public static void main ( final String[] array ) {
        ...
        final int[] union_Array = Union_Array ( find_Unique_Elements, find_Unique_Elements2 );
        ...
        for ( int k = 0; k < union_Array.length; ++k ) {
            System.out.print ( union_Array[k] + " " );
        }
        System.out.println();
    }
}
