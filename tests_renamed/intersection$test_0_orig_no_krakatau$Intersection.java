class Intersection {
    ...
    public static void main ( String[] a ) {
        ...
        a1[13] = 45;
        a1[14] = 55;
        int[] a2 = Intersection.Find_Unique_Elements ( a0 );
        int[] a3 = Intersection.Find_Unique_Elements ( a1 );
        int[] a4 = Intersection.Find_Common_Elements ( a0, a1 );
