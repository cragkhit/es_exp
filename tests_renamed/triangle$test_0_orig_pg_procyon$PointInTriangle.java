...
public class PointInTriangle extends Frame {
    ...
    public static void main ( final String[] array ) {
        ...
        for ( int j = 0; j < list.size(); ++j ) {
            pointInTriangle.a.addPoint ( ( int ) list.get ( j++ ), ( int ) list.get ( j ) );
        }
        ...
        if ( ( 0 + a ( list.get ( 0 ), list.get ( 1 ), list.get ( 2 ), list.get ( 3 ), a, a2, n, n2 ) + a ( list.get ( 2 ), list.get ( 3 ), list.get ( 4 ), list.get ( 5 ), a, a2, n, n2 ) + a ( list.get ( 4 ), list.get ( 5 ), list.get ( 0 ), list.get ( 1 ), a, a2, n, n2 ) ) % 2 == 1 ) {
