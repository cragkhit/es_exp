...
class Main
{
    ...
    public static int m10(final int n, final Stack stack, final Stack stack2, final Stack stack3) {
        if (n > 4) {
    ...
    public static void m20() {
        Label_0366: {
            if (Main.f40 == Main.f10.size()) {
                if (Main.f50 == Main.f20.size()) {
                    if (Main.f60 == Main.f30.size()) {
                        break Label_0366;
                    }
                }
            }
