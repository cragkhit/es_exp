...
class InfixConverter
{
    ...
    public static void main(final String[] array) {
        if (array.length != 1) {
            final String infixToPostfixConvert = InfixToPostfixConvert("a+b*c");
            System.out.println("InFix  :\t" + "a+b*c");
            System.out.println("PostFix:\t" + infixToPostfixConvert);
            System.out.println();
            final String infixToPostfixConvert2 = InfixToPostfixConvert("a+b*c/d-e");
            System.out.println("InFix  :\t" + "a+b*c/d-e");
            System.out.println("PostFix:\t" + infixToPostfixConvert2);
            System.out.println();
            final String infixToPostfixConvert3 = InfixToPostfixConvert("a+b*c/d-e+f*h/i+j-k");
            ...
            final String infixToPostfixConvert4 = InfixToPostfixConvert(str);
