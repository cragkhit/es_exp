...
class InfixConverter
{
    ...
    public static void main(final String[] array) {
        if (array.length == 1) {
            ...
            final String infixToPostfixConvert2 = InfixToPostfixConvert("a+b*c");
            System.out.println("InFix  :\ta+b*c");
            System.out.println("PostFix:\t" + infixToPostfixConvert2);
            System.out.println();
            final String infixToPostfixConvert3 = InfixToPostfixConvert("a+b*c/d-e");
            System.out.println("InFix  :\ta+b*c/d-e");
            System.out.println("PostFix:\t" + infixToPostfixConvert3);
            System.out.println();
            final String infixToPostfixConvert4 = InfixToPostfixConvert("a+b*c/d-e+f*h/i+j-k");
