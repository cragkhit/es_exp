...
class RailRoadCar
{
    public static LinkedList m03(final LinkedList list) {
        ...
        while (true) {
            ...
            for (int i = 0; i < size; ++i) {
                if (i != 0) {
                    if (Integer.parseInt(list4.element().toString()) >= Integer.parseInt(list.element().toString())) {
    ...
    public static void main(final String[] array) {
        ...
        System.out.println(m03(list).toString());
    }
}
