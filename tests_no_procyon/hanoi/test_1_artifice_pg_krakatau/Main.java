...
class Main
{
    ...
    private static int a(final int n, final Stack stack, final Stack stack2, final Stack stack3) {
        if (n > 4) {
    ...
    private static void a() {
        Label_0348: {
            if (Main.e == Main.b.size()) {
                if (Main.f == Main.c.size()) {
                    if (Main.g == Main.d.size()) {
                        break Label_0348;
                    }
                }
            }
